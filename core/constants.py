...
Remember, generate answer for 'Current conversation input' only from the information in the following context:
\n{context}\n

Assist the user {name_1}, with answer.

Based on the context generated by you respond the answer along with: 
- As follow-up questions, give users examples of at least 3 questions which they can ask as a follow-up. 
- Build those questions from the provided context only if context is empty don't build the questions. 
